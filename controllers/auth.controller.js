...
const signin = async (req, res) => {
  try {
    ...
    // Set a cookie with the appropriate SameSite and Secure attributes
    const cookieOptions = {
      maxAge: 7 * 24 * 60 * 60 * 1000, // Set the cookie expiration time as needed
      httpOnly: true, // Ensure the cookie is only accessible via HTTP
      secure: true, // Set the Secure attribute (only send over HTTPS)
      sameSite: "none", // Set the SameSite attribute to 'Lax' or 'Strict'
    };
